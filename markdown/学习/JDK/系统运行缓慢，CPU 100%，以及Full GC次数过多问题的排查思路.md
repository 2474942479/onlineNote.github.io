# [系统运行缓慢，CPU 100%，以及Full GC次数过多问题的排查思路](https://my.oschina.net/zhangxufeng/blog/3017521)
...
![image-1.png](../../markdown/图片/65fe863f6fe94eb05e48fd0835637be726d.jpg)
...
![img](../../markdown/图片/e1146eddc2dbf10ff28534abda323761369.jpg)
...
![img](../../markdown/图片/d488242cef4cddc3e27c6cb737d0a7cc3ec.jpg)
...
- 如果通过
  ...
  命令看到CPU并不高，并且系统内存占用率也比较低。此时就可以考虑是否是由于另外三种情况导致的问题。具体的可以根据具体情况分析：
